...
best_epoch = 13
model = torch.load(f"{config['save_model_dir']}/two_stage_7_2.pt")
model = model.to(torch.float)
...
print(
    f"Test accuracy is :{correct_test/total_test*100:.2f}%"
)
print(
    f"Test loss is :{loss_accum_test/total_test:.2f}"
)
